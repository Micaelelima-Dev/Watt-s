...
<body>
    ...
    <div class="container">
        ...
        <table>
            ...
            <tbody>
                <?php
                $sql = "SELECT id_funcionario, nome_funcionario, cpf, data_contratacao, ativo FROM funcionarios ORDER BY nome_funcionario ASC";
                ...
                if ($resultado && $resultado->num_rows > 0) {
                    ...
                    echo "<tr><td colspan='5' style='text-align:center;'>Nenhum funcionário cadastrado.</td></tr>";
                }
                ?>
            </tbody>
        </table>
        ...
        <a href="cadastrar.php" class="btn-voltar">
            ...
            </svg> Cadastrar novo funcionário</a><br>
